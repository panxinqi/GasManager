...
<body class="">
	<form id="signupForm" action="amount/amountToPayment" method="post">
		...
		<div class="header"><h1 class="page-title">交费单详情</h1></div>
		<ul class="breadcrumb">
			<li><a href="index.jsp" target="_top">抄表管理</a> <span class="divider">/</span></li>
			<li class="active">交费单详情</li>
		</ul>
		...
		<div class="container-fluid">
					...
					<div class="well" style="margin:0px;">
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="home">
								...
								<lable>缴费日期：${payment.payDate }</lable><br/>
							</div>
						</div>
					</div>
			...
			<div class="btn-toolbar">
				<a href="amount/amountPaymentList" class="btn btn-primary">返回上一级</a>
			</div>	
