...
<body class="">
	<form id="signupForm" action="pay/paymentPayMoney" method="post">
		<!-- 设置隐藏文本框 报销单编码-->
		...
		<div class="header"><h1 class="page-title">正在缴费</h1></div>
		<ul class="breadcrumb">
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<!-- 获取session的值显示信息 -->
				<div  style="color:red" align="left">${payinfo }</div>
			...
			<div class="btn-toolbar" align="right">
				<a href="pay/paymentList" class="btn btn-primary">返回上一级</a>
				<button class="btn btn-info" type="submit" ><i class="icon-save"></i> 确定缴费</button>
			</div>	
