...
<body class="">
	...
	<%-- 测试 显示获取的用户ＩＤ<input type="text" name="userId" value="${user.userId }"/> --%>
	
		<div class="header"><h1 class="page-title">修改用户</h1></div>
		<ul class="breadcrumb">
				...
				<div class="well">
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							...
							<input type="hidden" name="userId"  value="${user.userId }" class="input-xlarge">
						
							<label>余额</label> 
							<input type="text" name="balance"  value="${user.balance }" placeholder="金额" class="input-xsmall">
							<label>密码</label> 
							<input type="text" name="userPwd"  value="${user.userPwd }" placeholder="请输入密码" class="input-xlarge"> 
							<label>姓名</label> 
							<input type="text" name="userName"  value="${user.userName }" placeholder="请输入姓名" class="input-xlarge">
							<label>性别</label>
							<input type="radio" name="sex" value="男" ${user.sex eq '男' ? 'checked':'' } class="input-xlarge">男  
							<input type="radio" name="sex" value="女" ${user.sex eq '女' ? 'checked':'' } class="input-xlarge">女 
							<label>地址</label> 
							<input type="text" name="address" value="${user.address }" placeholder="请输入地址" class="input-xlarge">
							<label>电话</label> 
							<input type="text" name="phone"  value="${user.phone }" placeholder="请输入电话号码" class="input-xlarge">
							<label>角色</label> 
							<select name="role" >
